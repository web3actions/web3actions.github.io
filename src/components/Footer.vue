<template>
  <div class="bg-indigo-900">
    <div class="container mx-auto px-5 py-10 text-center space-x-3">
      <a href="https://github.com/web3actions/web3actions.github.io/discussions" target="__blank" class="inline-block text-gray-50 hover:bg-white hover:text-indigo-700 rounded-xl text-xl px-4 py-3">
