<template>
  <div class="bg-white">
    <div class="container mx-auto px-5 py-10 text-center space-x-3">
      <a href="https://github.com/cryptoactions/cryptoactions.github.io/discussions" target="__blank" class="inline-block text-indigo-500 hover:bg-indigo-50 hover:text-indigo-700 rounded-xl text-xl px-4 py-3">
